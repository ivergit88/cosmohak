...
s.addText([
  ...
  { text: "Ни один ID (C65, G_MUR, S01…) и ни одно число не захардкожены: состав, плоскости и параметры целиком читаются из файла. Проверено на синтетическом сценарии с 5 плоскостями, 2 шлюзами и незнакомыми идентификаторами.", options: { color: MUTED } },
...
const algo = [
  ...
  ["Маршрут — детерминированный BFS", "минимум рёбер, при равенстве — лексикографически наименьший путь; наземные узлы не ретранслируют"],
...
const q = [
  { n: "83", t: "автотеста: валидация, границы отказов,\nмаршрутизация, метрики, экспорт, UI", c: PRIMARY },
